/*
* $Id: sjis2uc.h,v 1.2 2002-02-18 15:55:22 pgr Exp $
*
...
STATIC const UCS_2 SJIS2UC_SB[256] = {
  ...
  0x78, 0x79, 0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x7F, 0x80, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  0xA0, 0xFF61, 0xFF62, 0xFF63, 0xFF64, 0xFF65, 0xFF66, 0xFF67, 0xFF68, 0xFF69,
  0xFF6A, 0xFF6B, 0xFF6C, 0xFF6D, 0xFF6E, 0xFF6F, 0xFF70, 0xFF71, 0xFF72, 0xFF73,
  0xFF74, 0xFF75, 0xFF76, 0xFF77, 0xFF78, 0xFF79, 0xFF7A, 0xFF7B, 0xFF7C, 0xFF7D,
  0xFF7E, 0xFF7F, 0xFF80, 0xFF81, 0xFF82, 0xFF83, 0xFF84, 0xFF85, 0xFF86, 0xFF87,
  0xFF88, 0xFF89, 0xFF8A, 0xFF8B, 0xFF8C, 0xFF8D, 0xFF8E, 0xFF8F, 0xFF90, 0xFF91,
  0xFF92, 0xFF93, 0xFF94, 0xFF95, 0xFF96, 0xFF97, 0xFF98, 0xFF99, 0xFF9A, 0xFF9B,
  0xFF9C, 0xFF9D, 0xFF9E, 0xFF9F, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, UCS_MBSTART,
  UCS_MBSTART, UCS_MBSTART, UCS_MBSTART, 0xFD, 0xFE, 0xFF
};

#define MBTBLSZ 7808

STATIC const UCS_2 SJIS2UC_DB[MBTBLSZ] = {
  ...
  0x25BC, 0x203B, 0x3012, 0x2192, 0x2190, 0x2191, 0x2193, 0x3013, UCS_UNDEFINED,
  ...
  0x2208, 0x220B, 0x2286, 0x2287, 0x2282, 0x2283, 0x222A, 0x2229, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x2227, 0x2228, 0x00AC, 0x21D2, 0x21D4,
  0x2200, 0x2203, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x2220, 0x22A5, 0x2312, 0x2202, 0x2207, 0x2261, 0x2252,
  0x226A, 0x226B, 0x221A, 0x223D, 0x221D, 0x2235, 0x222B, 0x222C, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x212B, 0x2030, 0x266F, 0x266D, 0x266A,
  0x2020, 0x2021, 0x00B6, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x25EF, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0xFF10, 0xFF11, 0xFF12, 0xFF13, 0xFF14, 0xFF15, 0xFF16,
  0xFF17, 0xFF18, 0xFF19, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, 0xFF21, 0xFF22, 0xFF23, 0xFF24, 0xFF25, 0xFF26, 0xFF27, 0xFF28, 0xFF29, 0xFF2A,
  0xFF2B, 0xFF2C, 0xFF2D, 0xFF2E, 0xFF2F, 0xFF30, 0xFF31, 0xFF32, 0xFF33, 0xFF34,
  0xFF35, 0xFF36, 0xFF37, 0xFF38, 0xFF39, 0xFF3A, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0xFF41, 0xFF42, 0xFF43, 0xFF44, 0xFF45, 0xFF46, 0xFF47, 0xFF48,
  0xFF49, 0xFF4A, 0xFF4B, 0xFF4C, 0xFF4D, 0xFF4E, 0xFF4F, 0xFF50, 0xFF51, 0xFF52,
  0xFF53, 0xFF54, 0xFF55, 0xFF56, 0xFF57, 0xFF58, 0xFF59, 0xFF5A, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x3041, 0x3042, 0x3043, 0x3044, 0x3045, 0x3046, 0x3047, 0x3048,
  ...
  0x308F, 0x3090, 0x3091, 0x3092, 0x3093, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x30A1, 0x30A2, 0x30A3, 0x30A4,
  ...
  0x30F5, 0x30F6, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, 0x0391, 0x0392, 0x0393, 0x0394, 0x0395, 0x0396, 0x0397, 0x0398, 0x0399, 0x039A,
  0x039B, 0x039C, 0x039D, 0x039E, 0x039F, 0x03A0, 0x03A1, 0x03A3, 0x03A4, 0x03A5,
  0x03A6, 0x03A7, 0x03A8, 0x03A9, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x03B1, 0x03B2, 0x03B3, 0x03B4, 0x03B5, 0x03B6, 0x03B7, 0x03B8,
  0x03B9, 0x03BA, 0x03BB, 0x03BC, 0x03BD, 0x03BE, 0x03BF, 0x03C0, 0x03C1, 0x03C3,
  0x03C4, 0x03C5, 0x03C6, 0x03C7, 0x03C8, 0x03C9, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415,
  ...
  0x0429, 0x042A, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x0430, 0x0431, 0x0432, 0x0433, 0x0434, 0x0435, 0x0451, 0x0436,
  ...
  0x044B, 0x044C, 0x044D, 0x044E, 0x044F, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x2500, 0x2502,
  ...
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x2460, 0x2461,
  0x2462, 0x2463, 0x2464, 0x2466, 0x2467, 0x2468, 0x2469, 0x246A, 0x246B, 0x246C,
  0x246D, 0x246E, 0x246F, 0x2470, 0x2471, 0x2472, 0x2473, 0x2474, 0x2160, 0x2161,
  0x2162, 0x2163, 0x2164, 0x2165, 0x2166, 0x2167, 0x2168, 0x2169, UCS_UNDEFINED,
  0x3349, 0x3314, 0x3322, 0x334D, 0x3318, 0x3327, 0x3303, 0x3336, 0x3351, 0x3357, 0x330D,
  0x3326, 0x3323, 0x332B, 0x334A, 0x333B, 0x339C, 0x339D, 0x339E, 0x338E, 0x338F,
  0x33C4, 0x33A1, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, 0x337B, 0x301E, 0x301F, 0x2116, 0x33CD, 0x2121, 0x32A4, 0x32A5, 0x32A6, 0x32A7,
  ...
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, 0x4E9C, 0x5516, 0x5A03, 0x963F, 0x54C0, 0x611B, 0x6328, 0x59F6, 0x9022, 0x8475,
  ...
  0x8568, 0x6900, 0x6E7E, 0x7897, 0x8155, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED,
  UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, UCS_UNDEFINED, 0x5F0C, 0x4E10,
