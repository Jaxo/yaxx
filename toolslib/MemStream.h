/*
* $Id: MemStream.h,v 1.15 2011-07-29 10:26:36 pgr Exp $
*
...
+----------------------------------------------------------------------------*/
class TOOLS_API MemStreamBuf : public streambuf {
public:
   enum e_Given    { Given };
...
|           that the original string stay so for the life of the MemStream!   |
|                                                                             |
...
|                                                                             |
+----------------------------------------------------------------------------*/
class TOOLS_API MemStream : public iostream {
public:
   enum e_Given    { Given };
   enum e_Constant { Constant };
